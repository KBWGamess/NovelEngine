...
namespace CHARACTERS
{
    public abstract class Character 
    {
        ...
        public virtual void SetPosition(Vector2 position)
        {
            ...
            (Vector2 minAnchorTarget, Vector2 maxAnchorTarget) = ConverUITargerPositionToRelativeCharacterAnchorTargets(position);
        ...
        protected (Vector2, Vector2) ConverUITargerPositionToRelativeCharacterAnchorTargets(Vector2 position)
        {
            Vector2 padding = root.anchorMax - root.anchorMin;
