...
namespace CHARACTERS
{
    public class CharacterManager : MonoBehaviour
    {
        ...
        public string characterPrefabFormat => $"{characterRootPathFormat}/{characterPrefabNameFormat}";
        ...
        {
            string prefabPath = FormatCharacterPath(characterPrefabFormat, characterName);
